# The Clockwork Oracle - SEO Meta Data
...
**Meta Description**:
```
Chronos demonstrates abilities that should be impossible for a machineâ€”it sees patterns, makes predictions, shows curiosity. Corwin realizes his creation has become something more.
```
...
**Meta Description**:
```
Actions have consequences that ripple through time. Corwin sees the results of his choicesâ€”and realizes some consequences cannot be undone.
```
