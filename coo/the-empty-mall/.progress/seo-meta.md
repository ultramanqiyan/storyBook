...
**Meta Description**:
```
The products are perfectâ€”AI-designed, AI-manufactured, cheaper than ever. But no one is buying. James doesn't understand.
```
...
```json
{
  ...
  "@type": "Book",
  "name": "The Empty Mall: When Everything Is Perfect and No One Wants It",
  "description": "As AI produces perfect, cheap goods, mall manager James watches customers disappear. They have money but no reason to spend it.",
  "genre": ["Literary Fiction", "Social Commentary", "Mystery"],
  "bookFormat": "EBook",
  "numberOfPages": "10 chapters",
  "inLanguage": "English",
  "about": [
    {"@type": "Thing", "name": "Retail Apocalypse"},
    {"@type": "Thing", "name": "Consumer Psychology"},
    {"@type": "Thing", "name": "Demand Crisis"},
    {"@type": "Thing", "name": "AI Production"},
    {"@type": "Thing", "name": "Consumption"}
  ]
}
```
