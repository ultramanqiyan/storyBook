...
('card-adv003-w03', 'preset-adventure-003', 'plot', 'weather', '星空夜', '🌙', '繁星点点的夜晚，
萤火虫闪烁'),
('card-adv003-w04', 'preset-adventure-003', 'plot', 'weather', '彩虹天', '🌈', '雨后的彩虹，
丛林更加美丽'),
-- terrain (4张)
('card-adv003-t01', 'preset-adventure-003', 'plot', 'terrain', '丛林', '🌲', '神秘的丛林，
充满未知'),
('card-adv003-t02', 'preset-adventure-003', 'plot', 'terrain', '瀑布', '💦', '壮观的瀑布，
隐藏着洞穴'),
('card-adv003-t03', 'preset-adventure-003', 'plot', 'terrain', '榕树下', '🌳', '千年榕树，
丛林长老'),
('card-adv003-t04', 'preset-adventure-003', 'plot', 'terrain', '萤火虫小径', '✨', '萤火虫指引的神秘小路'),
-- adventure (4张)
('card-adv003-a01', 'preset-adventure-003', 'plot', 'adventure', '探险', '🧭', '探索未知的地方，
发现秘密'),
('card-adv003-a02', 'preset-adventure-003', 'plot', 'adventure', '解谜', '🧩', '解开古老的谜题，
获得线索'),
('card-adv003-a03', 'preset-adventure-003', 'plot', 'adventure', '救援', '🆘', '救援被困的朋友，
保护丛林'),
('card-adv003-a04', 'preset-adventure-003', 'plot', 'adventure', '守护使命', '🛡️', '守护丛林，
保护自然'),
-- equipment (4张)
('card-adv003-e01', 'preset-adventure-003', 'plot', 'equipment', '老地图', '🗺️', '神秘的古老地图，
指引方向'),
('card-adv003-e02', 'preset-adventure-003', 'plot', 'equipment', '相机', '📷', '拍摄美景，
记录发现'),
('card-adv003-e03', 'preset-adventure-003', 'plot', 'equipment', '手电筒', '🔦', '照亮黑暗，
探索洞穴'),
...
INSERT INTO plot_cards (card_id, book_id, type, sub_type, name, icon, description) VALUES
-- weather (4张)
('card-adv004-w01', 'preset-adventure-004', 'plot', 'weather', '雪天', '❄️', '银装素裹的雪景，
极地的美丽'),
('card-adv004-w02', 'preset-adventure-004', 'plot', 'weather', '极光', '🌌', '绚丽的极光，
北极的灵魂'),
('card-adv004-w03', 'preset-adventure-004', 'plot', 'weather', '蓝天', '🌤️', '湛蓝的天空，
极地的清澈'),
('card-adv004-w04', 'preset-adventure-004', 'plot', 'weather', '暴风雪', '🌨️', '猛烈的暴风雪，
极地的考验'),
-- terrain (4张)
('card-adv004-t01', 'preset-adventure-004', 'plot', 'terrain', '冰原', '🧊', '广阔的冰原，
北极的世界'),
('card-adv004-t02', 'preset-adventure-004', 'plot', 'terrain', '冰川', '🏔️', '巍峨的冰川，
极地的壮丽'),
('card-adv004-t03', 'preset-adventure-004', 'plot', 'terrain', '冰洞', '🪨', '神秘的冰洞，
蓝色的光芒'),
('card-adv004-t04', 'preset-adventure-004', 'plot', 'terrain', '科考站', '🔬', '科研基地，
探险的起点'),
-- adventure (4张)
('card-adv004-a01', 'preset-adventure-004', 'plot', 'adventure', '救援', '🆘', '救援被困的朋友，
保护北极'),
('card-adv004-a02', 'preset-adventure-004', 'plot', 'adventure', '科考', '🔬', '科学研究，
了解北极'),
('card-adv004-a03', 'preset-adventure-004', 'plot', 'adventure', '守护使命', '🛡️', '守护北极，
保护地球'),
('card-adv004-a04', 'preset-adventure-004', 'plot', 'adventure', '观察动物', '🦋', '观察北极动物，
了解生态'),
-- equipment (4张)
('card-adv004-e01', 'preset-adventure-004', 'plot', 'equipment', '相机', '📷', '记录北极的美丽与变化'),
('card-adv004-e02', 'preset-adventure-004', 'plot', 'equipment', '羽绒服', '🧥', '保暖的衣物，
抵御严寒'),
('card-adv004-e03', 'preset-adventure-004', 'plot', 'equipment', '望远镜', '🔭', '观察远方，
发现动物'),
('card-adv004-e04', 'preset-adventure-004', 'plot', 'equipment', '徽章', '🏅', '北极守护者徽章，
荣誉象征');
...
-- terrain (4张)
('card-fan003-t01', 'preset-fantasy-003', 'plot', 'terrain', '龙之巢', '🐉', '巨龙的巢穴，
龙族的家园'),
...
-- adventure (4张)
('card-fan003-a01', 'preset-fantasy-003', 'plot', 'adventure', '屠龙', '🐉', '挑战巨龙，
证明勇气'),
...
-- equipment (4张)
('card-fan003-e01', 'preset-fantasy-003', 'plot', 'equipment', '龙鳞甲', '🛡️', '龙鳞制成的护甲，
坚不可摧'),
...
INSERT INTO plot_cards (card_id, book_id, type, sub_type, name, icon, description) VALUES
-- weather (4张)
('card-fan004-w01', 'preset-fantasy-004', 'plot', 'weather', '时空裂隙', '🌀', '时空扭曲的裂缝，
穿越的通道'),
...
-- terrain (4张)
('card-fan004-t01', 'preset-fantasy-004', 'plot', 'terrain', '魔法塔', '🗼', '高耸的魔法塔，
学院的核心'),
...
-- adventure (4张)
('card-fan004-a01', 'preset-fantasy-004', 'plot', 'adventure', '时空穿梭', '⏳', '穿越时空，
逃离困境'),
...
-- equipment (4张)
('card-fan004-e01', 'preset-fantasy-004', 'plot', 'equipment', '护身符', '🧿', '保护佩戴者，
抵御魔法'),
...
INSERT INTO plot_cards (card_id, book_id, type, sub_type, name, icon, description) VALUES
-- weather (4张)
('card-rom003-w01', 'preset-romance-003', 'plot', 'weather', '夕阳', '🌇', '浪漫的夕阳，
温暖的时光'),
('card-rom003-w02', 'preset-romance-003', 'plot', 'weather', '雨天', '🌧️', '淅淅沥沥的雨，
邂逅的开始'),
('card-rom003-w03', 'preset-romance-003', 'plot', 'weather', '晴天', '☀️', '阳光明媚，
适合约会'),
('card-rom003-w04', 'preset-romance-003', 'plot', 'weather', '月色', '🌙', '皎洁的月光，
浪漫的夜晚'),
-- terrain (4张)
('card-rom003-t01', 'preset-romance-003', 'plot', 'terrain', '咖啡厅', '☕', '温馨的咖啡厅，
故事开始的地方'),
('card-rom003-t02', 'preset-romance-003', 'plot', 'terrain', '画廊', '🖼️', '艺术的画廊，
心动的瞬间'),
('card-rom003-t03', 'preset-romance-003', 'plot', 'terrain', '画室', '🎨', '创作的空间，
共同的梦想'),
('card-rom003-t04', 'preset-romance-003', 'plot', 'terrain', '街道', '🛤️', '安静的街道，
浪漫的散步'),
-- adventure (4张)
('card-rom003-a01', 'preset-romance-003', 'plot', 'adventure', '邂逅', '💫', '命运的相遇，
爱情的开始'),
...
-- equipment (4张)
('card-rom003-e01', 'preset-romance-003', 'plot', 'equipment', '画板', '🎨', '艺术的创作，
表达心意'),
...
INSERT INTO plot_cards (card_id, book_id, type, sub_type, name, icon, description) VALUES
-- weather (4张)
('card-rom004-w01', 'preset-romance-004', 'plot', 'weather', '樱花雨', '🌸', '樱花飘落的美景，
浪漫的回忆'),
('card-rom004-w02', 'preset-romance-004', 'plot', 'weather', '晴天', '☀️', '阳光明媚，
重逢的日子'),
('card-rom004-w03', 'preset-romance-004', 'plot', 'weather', '夕阳', '🌇', '浪漫的夕阳'),
('card-rom004-w04', 'preset-romance-004', 'plot', 'weather', '月色', '🌙', '皎洁的月光'),
-- terrain (4张)
('card-rom004-t01', 'preset-romance-004', 'plot', 'terrain', '校园', '🏫', '青春的校园，
回忆的地方'),
...
-- adventure (4张)
('card-rom004-a01', 'preset-romance-004', 'plot', 'adventure', '重逢', '🎉', '再次相遇，
旧情复燃'),
...
-- equipment (4张)
('card-rom004-e01', 'preset-romance-004', 'plot', 'equipment', '信纸', '✉️', '手写的情书，
传递心意'),
...
INSERT INTO plot_cards (card_id, book_id, type, sub_type, name, icon, description) VALUES
-- weather (4张)
('card-bus003-w01', 'preset-business-003', 'plot', 'weather', '晴天', '☀️', '晴朗的天气，
新的开始'),
('card-bus003-w02', 'preset-business-003', 'plot', 'weather', '阴天', '☁️', '阴沉的天空，
挑战来临'),
('card-bus003-w03', 'preset-business-003', 'plot', 'weather', '彩虹', '🌈', '雨后彩虹，
成功在望'),
('card-bus003-w04', 'preset-business-003', 'plot', 'weather', '晨光', '🌅', '温暖的晨光，
创业的希望'),
-- terrain (4张)
('card-bus003-t01', 'preset-business-003', 'plot', 'terrain', '办公室', '🏢', '创业的办公室，
梦想的起点'),
...
-- adventure (4张)
('card-bus003-a01', 'preset-business-003', 'plot', 'adventure', '融资', '💰', '获得融资，
企业发展'),
...
-- equipment (4张)
('card-bus003-e01', 'preset-business-003', 'plot', 'equipment', '笔记本电脑', '💻', '工作必备，
创业的工具'),
...
INSERT INTO plot_cards (card_id, book_id, type, sub_type, name, icon, description) VALUES
-- weather (4张)
('card-bus004-w01', 'preset-business-004', 'plot', 'weather', '阴天', '☁️', '阴沉的天空，
职场的挑战'),
...
-- terrain (4张)
('card-bus004-t01', 'preset-business-004', 'plot', 'terrain', '办公室', '🏢', '忙碌的办公室，
成长的战场'),
...
-- adventure (4张)
('card-bus004-a01', 'preset-business-004', 'plot', 'adventure', '突破', '🚀', '取得突破，
证明自己'),
...
-- equipment (4张)
('card-bus004-e01', 'preset-business-004', 'plot', 'equipment', '笔记本', '📓', '工作记录，
成长的见证'),
