...
DELETE FROM puzzles WHERE chapter_id IN (
  ...
  WHERE book_id LIKE 'preset-ai-%-zh'
     OR book_id LIKE 'preset-adventure-003'
     ...
     OR book_id LIKE 'preset-adventure-003-en'
     OR book_id LIKE 'preset-adventure-004-en'
     OR book_id LIKE 'preset-fantasy-003-en'
     OR book_id LIKE 'preset-fantasy-004-en'
     OR book_id LIKE 'preset-romance-003-en'
     OR book_id LIKE 'preset-romance-004-en'
     OR book_id LIKE 'preset-business-003-en'
     OR book_id LIKE 'preset-business-004-en'
);
