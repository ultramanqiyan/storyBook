const translations = {
  en: {
    ...
    create: {
      ...
      companion: 'Companion',
      addCompanion: 'Add Another Companion (Max 3)',
      remove: 'Remove',
      createStory: 'Create Story',
      storyCreated: 'Story Created!',
      storyCreatedDesc: 'Your story is ready to begin. Start writing your first chapter or let the Director guide you.',
  ...
  zh: {
    ...
    create: {
      ...
      companion: '伙伴',
      addCompanion: '添加更多伙伴（最多3个）',
      remove: '移除',
      createStory: '创建故事',
      storyCreated: '故事创建成功！',
      storyCreatedDesc: '你的故事已经准备就绪。开始创作第一章，或让导演引导你。',
      startWriting: '开始写作',
      useDirector: '使用导演'
    },
    stylePanel: {
